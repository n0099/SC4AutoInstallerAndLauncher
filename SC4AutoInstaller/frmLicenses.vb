Public Class frmLicenses
    ...
    ''' <summary>一个用于存储用户已阅读的协议文件数的整形变量</summary>
    Dim i As Integer
    ''' <summary>一个用于存储协议文件路径的字符串数组</summary>
    Dim Licenses() As String = {"Data\Licenses\CC BY-NC-SA.rtf", "Data\Licenses\CC BY-NC-SA 3.0 法律文本.rtf",
    ...
    Private Sub btnAgree_Click(sender As Object, e As EventArgs) Handles btnAgree.Click
        Select Case i
            ...
            Case 5
                If ModuleDeclare.InstalledModule Is Nothing Then frmInstallOptions.Show() Else frmChangeOptions.Show() '判断是否已经安装了模拟城市4
